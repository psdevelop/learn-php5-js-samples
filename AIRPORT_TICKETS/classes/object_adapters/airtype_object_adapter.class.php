...
class AirTypeObjectAdapter extends ObjectAdapter implements ObjectManipInterface  {
     ...
     function __construct($table_name, $class_name)    {
        ...
        $this->fields_prev_text_array = array("id"=>"ID","type_name"=>"Тип воздушного судна");
        $this->fields_width_array = array("id"=>10,"type_name"=>25);
        $this->select_display_field = "type_name";
        $this->manip_form_template = "<table><tr><td>***___type_name</td><td></td><td>***___id</td></tr>
            </table>";
     ...
     function writeTableHeader($linked_props)    {
        ...
        parent::write_header_td("Тип воздушного судна",75);
     ...
     function writeTableRow($object, $linked_props)    {
        ...
        parent::write_td($object->type_name,75);
